...
func (s *OpstackProposalDBTestSuite) TestFindForVerification() {
	...
	s.DatabaseTestSuite.db.OPContract.SaveNextIndex(l2oo0.Address, 3)
	s.DatabaseTestSuite.db.OPContract.SaveNextIndex(l2oo1.Address, 4)
